package nl.ind.gebeurtenissturingpoc.ledenviewservice;
...
public class SimpleKafkaTest {
    ...
    private static final String LIDAANGEMELD_PUBLISH_TOPIC = "event.leden";
    ...
    @Test
    public void lidAangemeldConsumerTest() throws InterruptedException {
        Integer key = 1;  
        Object payload = new Object();

        ProducerRecord<Integer, Object> producerRecord = new ProducerRecord<>(LIDAANGEMELD_PUBLISH_TOPIC, key, payload);
